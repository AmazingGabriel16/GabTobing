import stream_schedule_data from '../datasets/upcoming-stream-info.json'
...
console.log('Stream-schedule script working! - TS mode')
...
// https://stackoverflow.com/questions/45712292/how-to-add-innerhtml-in-typescript

//let card_html_container  = document.getElementById('stream-schedule-cards-section') as HTMLInputElement
//card_html_container.value = card_set