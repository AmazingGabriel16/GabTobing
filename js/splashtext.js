...
var array = [
    ...
    "BRING I.T. ON",
	"gab.com be da wae",
    "Cyberpunk 2077 - Finally released... Bug DLC included FREE!",
    "The oak tree, and the writing on the statue",
    "Notepad++",
    "Geronimo!",
    "Plan ",
    "Hands Up!",
    "YouTube: So anyways, I started recommending",
    "Eubela Research Station", /*Name still to be decided I guess...*/
    "7 Up!",
    "ACME approved!",
    "u noob",
    "taymidas uWu",
    ...
    "The rule of the internet... but bend it a little",
    "Like Scoob!",
    "dude... these pills be rockin... wait who am I?"/*
    "",
    "",
    "",
    "",
